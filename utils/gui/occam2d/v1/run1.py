...
class MyForm(QtGui.QMainWindow):
    ...
    def run_occam(self):
        ...
        startstring = "%s %s %s"%(exename,modname,startfile)
        ...
        logfilename    = op.abspath(op.realpath(op.join(self.ui.wd,'occamlog.log')))
        errfilename    = op.abspath(op.realpath(op.join(self.ui.wd,'occamerr.log')))

        logfil = file(logfilename,'w')
        errfil = file(errfilename,'w')
