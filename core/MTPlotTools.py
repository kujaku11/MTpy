        ...
        try:
            ...
            #blue to yellow to red
                ...
                if abs(cvar)>1:
                    ...
                    ellipd.set_facecolor((abs(cvar),abs(cvar),1))
                elif cvar>0:
                    ellipd.set_facecolor((1,1-abs(cvar),abs(cvar)))
            #blue to white to red
            elif cmap=='skcmap2':
                if abs(cvar)>1:
                    ellipd.set_facecolor((0,0,0))
            ...
            if indarrows=='y':
                ...
                ax.arrow(imp.lon,imp.lat,txr,tyr,lw=.5*awidth,facecolor='k',
                          edgecolor='k',length_includes_head=False,
                          head_width=awidth,head_length=aheight)
                ax.arrow(imp.lon,imp.lat,txi,tyi,lw=.5*awidth,facecolor='b',
